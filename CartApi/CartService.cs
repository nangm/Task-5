...
public class CartService : BackgroundService
{
    ...
    public CartService(ILoggerFactory loggerFactory)
    {
    ...
    private void InitRabbitMQ()
    {
        ...
        _channel.QueueDeclare("order-processed", false, false, false, null);
    ...
    private void HandleMessage(string content)
    {
        ...
        _logger.LogInformation($"cart received {content}");
